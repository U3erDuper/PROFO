...
//will return 10 colours evenly distributed throughout the visible spectrum, the same colours will be returned 10 times in a cycle

//getSpectrumColourFromScaledValue(1 + Math.floor(Math.random() * 10), 10) //in a for loop where i: 1 .. 10
//will return 1 colour from a palette of 10 colours evenly distributed throughout the visible spectrum randomly
