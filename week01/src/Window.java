...
public class Window extends JFrame {
    ...
    public Window(){
        ...
        inTextArea = new JTextArea("Replace Me!!!", 30, 10);
        ...
        //outPanel contents
        String instructions = "Replace the text above with your first name\nthen press the 'Do It !' button.";
        outTextArea = new JTextArea(instructions, 30, 10);
        ...
        outFontButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (outTextArea.getFont().getName().equals("Arial"))
                    ...
                    f = new Font("Georgia", Font.PLAIN, 24);
